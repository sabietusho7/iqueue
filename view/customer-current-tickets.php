                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <table class="table card-text" id="dtBasicExample">
                                                    <thead>
                                                    <tr>
                                                        <th>Business</th>
                                                        <th>Desk Service</th>
                                                    ...
                                                    foreach ($tickets as $ticket) {
                                                        ...
                                                        echo "<tr";
                                                        if ($ticket->getStatus()->getId() == TicketStatus::$IN_QUEUE) {
                                                 ...
                                                 <td";
                                                        ...
                                                        echo ">" . $ticket->getStatus()->getName() . "</td>
                                                 <td>" . $ticket->getCount() . "</td>
                                                 <td>" . $ticket->getDate() . "</td>";

                                                        if ($ticket->getStatus()->getId() == TicketStatus::$IN_QUEUE) {
                                                            echo "<td><button type='submit' class='btn btn-danger' name='cancelTicket' value='{$ticket->getID()}'>Cancel</button></td>";
                                                        } else {
