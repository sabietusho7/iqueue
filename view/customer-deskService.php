...
if (isset($_SESSION["CustomerID"])) {
    ...
    if (isset($_GET["businessID"])) {
        ...
        $business= $businessController->getActiveBusinessById($businessID);
        $deskServices = $businessController->getActiveDeskServiceByBusinessId($businessID);
        if($business==null){
    ...
    <head>
        ...
        <title>Customer - Desk Service</title>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $business->getName(); ?></li>
                </ol>
            </nav>
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"
                ...
                if (count($deskServices) == 0 ) {
                    echo '<div class="alert alert-danger" role="alert" style="text-align:center; width:700px; margin:auto;">
            <h5 style="color:red; margin-top:100px; margin-bottom:100px">There are currently no registered Desk Services for this Business.</h5>
        </div>';
                }
                ?>
                <div class="containerBox">
                    ...
                    foreach ($deskServices as $deskService) {
                        echo "<a href='" . htmlspecialchars("customer-ticket.php?deskServiceID={$deskService->getID()}") . "'> <button type='button' class='btn btn-outline-primary' name='businessBtn' value='{$deskService->getID()}'>{$deskService->getName()}</button></a>";
                    }
                    ?>
                </div>
            </form>
