<?php
session_start();
if(isset($_SESSION['iQueueAdmin'])) {
    require_once '../controller/BusinessController.php';
    $userId = $_SESSION['iQueueAdmin'];
    require_once '../controller/UserController.php';
    $userController = new UserController();
    $admin = $userController->getUserByID($userId);
    $businessController = new BusinessController();
    $businesses = $businessController->getBusinesses();

    $business = null;
    if (isset($_GET['modifyBusinessId'])) {
        $business = $businessController->getBusinessById($_GET['modifyBusinessId']);
    }
    ...
    if (isset($_POST['registerBusiness'])) {
        header("location: admin-business-info.php");
    }
    if (isset($_POST["saveProfile"])) {
        ...
        if ($_POST["surname"] != "" && $_POST["surname"] != null && strlen($_POST["surname"]) != 0) {
            $admin->setSurname($_POST["surname"]);
        }
        ...
        if ($_POST["pass"] != "" && $_POST["pass"] != null  && strlen($_POST["pass"]) != 0) {
            ...
            $userController->updateUserNoPass($admin);
        }
                ...
                <div class="container-fluid">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"
                            data-whatever="@mdo"><i class='fas fa-user-circle' style='font-size: 25px'
                                                    value="<?php echo $_SESSION['iQueueAdmin'] ?>"></i> Profile
                    </button>
                </div>
            </nav>
                ...
                <div class="page-holder w-100 d-flex flex-wrap">
                    <div class="container-fluid px-xl-5">
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"
                            ...
                            <button name="registerBusiness" type="submit" class="btn btn-primary" id="registerBusiness">
...
//                                                    </label> </td>
                                                            " <td><a href='admin-business-info.php?businessId=" . $business->getId() . "'><button type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\"  data-whatever=' " . $business->getId() . "' ><i class='fas fa-edit' style='font-size: 20px'></i></button> </a> </td>";

                                                        echo "<td><a href='admin-business-delete.php?businessId=" . $business->getId() . "&managerId=" . $business->getManager()->getId() . "'><button type=\"button\" class=\"btn btn-danger\" data-toggle=\"modal\"  data-whatever=' " . $business->getId() . "' ><i class=\"fas fa-trash-alt\"></i></button> </a> </td>
                                               </tr>";
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td><input name="email" type="email" class="form-control"
                                                           ...
                                                           value="<?php echo $admin->getEmail(); ?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Phone</td>
                                                <td><input name="phone" type="text" class="form-control"
                                                           value="<?php echo $admin->getPhone(); ?>"></td>
                                            </tr>
                                            <tr>
                                                <td>New Password</td>
